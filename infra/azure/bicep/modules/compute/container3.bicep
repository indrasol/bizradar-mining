      ...
      containers: [
        {
          ...
          command: ['python']
          args: ['-m', 'sam_gov.workers.queue_pipeline.run_worker', '--worker', 'embedding']
          env: [
            {
            ...
            {
              name: 'AZURE_OPENAI_BASE_URL_BIZ'
              value: 'https://indra-ai.openai.azure.com/openai/v1/'
            }
            {
              name: 'AZURE_OPENAI_DEPLOYMENT_BIZ'
              value: 'gpt-4.1-mini'
            }
            {
              name: 'AZURE_OPENAI_EMBEDDING_MODEL_BIZ'
              value: 'text-embedding-3-small'
            }
            {
              name: 'EMBEDDING_MODEL_BIZ'
